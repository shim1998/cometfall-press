        ...
        <>
            <div className='project -z-20 overflow-x-clip'>
                ...
                <div className='flex flex-col mt-20'>
                    <div className='relative w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/4 m-auto z-20 p-2'>
                        <img src={worldtitle}/>
                    </div>
                    <div className='relative flex flex-col sm:mt-10 md:mt-20 lg:mt-20 xl:mt-20 md:flex-row lg:flex-row xl:flex-row m-auto w-[90%] h-50 place-items-center'>
                        <div className='w-3/4 md:2-2/3 xl:w-1/2 z-20 p-2 m-2'>
                            <img src={world}/>
                        </div>
                        <p className='sm:w-2/3 h-auto p-2 clear-both m-2 text-left text-pretty text-dark sm:text-sm md:text-md lg:text-lg xl:text-xl font-semibold'>
